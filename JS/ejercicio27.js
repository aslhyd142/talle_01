...
else if(numero_de_mes==3 || numero_de_mes==4 || numero_de_mes==5)
    console.log("la estacion es otoño")

else if(numero_de_mes==6 || numero_de_mes==7 || numero_de_mes==8)
    console.log("la estacion es invierno")

else  if(numero_de_mes==9 || numero_de_mes==10 || numero_de_mes==11)
